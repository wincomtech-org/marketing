...
// 定义常量
define('ROOT_PATH', str_replace(ADMIN_PATH . '/include/ajaxupload/action.php', '', str_replace('\\', '/', __FILE__)));
define('ROOT_URL', preg_replace('/admin\/include\/ajaxupload' . '\//Ums', '', dirname('http://' . $_SERVER['HTTP_HOST'] . $_SERVER['PHP_SELF']) . "/"));
