...
elseif ($rec == 'order') {
    ...
    // CSRF防御令牌生成
    if($action == 'default') $smarty->assign('token', $firewall->get_token());
    ...
    if(function_exists('curl_init')) {
        ...
        curl_setopt($ch, CURLOPT_REFERER, "http://cloud.Lothar.com" );  
        curl_setopt($ch, CURLOPT_URL, 'http://cloud.Lothar.com/order/extend_client');  
