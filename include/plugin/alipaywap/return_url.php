...
// 站点网址
$root_url = str_replace('include/plugin/alipay/', '', M_URL);
$order_list_url = str_replace('include/plugin/alipay/', '', $dou->rewrite_url('user', 'order_list'));
