<?php
/* Smarty version 3.1.30, created on 2017-08-31 09:30:04
  from "D:\WWW\marketing\admin\templates\article.htm" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59a7669c40a1b1_68029696',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bfd3fe8ef873980efa1d32209d8cda1718d4ef1b' => 
    array (
      0 => 'D:\\WWW\\marketing\\admin\\templates\\article.htm',
      1 => 1503294009,
      2 => 'file',
    ),
  ),
...
function content_59a7669c40a1b1_68029696 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
">
    ...
    <h3 style="padding-bottom:0;margin-bottom:0;"><a href="<?php echo $_smarty_tpl->tpl_vars['action_link']->value['href'];?>
" class="actionBtn add"><?php echo $_smarty_tpl->tpl_vars['action_link']->value['text'];?>
</a><?php echo $_smarty_tpl->tpl_vars['ur_here']->value;?>
</h3>
    <?php if ($_smarty_tpl->tpl_vars['allow_tpl']->value) {?>
    <div>
      允许被指定的模板<br>
      <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['allow_tpl']->value, 'tpl');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['tpl']->value) {
?>
      <?php echo $_smarty_tpl->tpl_vars['tpl']->value['name'];?>
：<?php echo $_smarty_tpl->tpl_vars['tpl']->value['tpl'];?>
<br>
      <?php
}
}
...
?>
    ...
    <form action="article.php" method="post">
     <select name="cat_id">
      ...
      <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['article_category']->value, 'cate');
if ($_from !== null) {
...
" />
    ...
    <a class="btnGray" href="article.php?rec=sort"><?php echo $_smarty_tpl->tpl_vars['lang']->value['sort_close'];?>
</a>
    <?php } else { ?>
    <a class="btnGray" href="article.php?rec=sort"><?php echo $_smarty_tpl->tpl_vars['lang']->value['sort_article'];?>
</a>
    <?php }?>
    </span>
    </div>
    ...
    <div class="homeSortRight">
     ...
     <ul class="homeSortList">
      <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['sort']->value, 'article', false, NULL, 'sort', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['article']->value) {
?>
      <li>
       <em><?php echo $_smarty_tpl->tpl_vars['article']->value['title'];?>
</em>
       <a href="article.php?rec=del_sort&id=<?php echo $_smarty_tpl->tpl_vars['article']->value['id'];?>
...
?>
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
     <tr>
      ...
      <th align="left"><?php echo $_smarty_tpl->tpl_vars['lang']->value['article_name'];?>
</th>
      <th width="150" align="center"><?php echo $_smarty_tpl->tpl_vars['lang']->value['article_category'];?>
</th>
      <th width="80" align="center"><?php echo $_smarty_tpl->tpl_vars['lang']->value['add_time'];?>
</th>
      <th width="80" align="center">指定模板</th>
...
?>
     <tr>
      <td align="center"><input type="checkbox" name="checkbox[]" value="<?php echo $_smarty_tpl->tpl_vars['article']->value['id'];?>
" /></td>
      <td align="center"><?php echo $_smarty_tpl->tpl_vars['article']->value['id'];?>
</td>
      <td><a href="article.php?rec=edit&id=<?php echo $_smarty_tpl->tpl_vars['article']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['article']->value['title'];?>
</a><?php if ($_smarty_tpl->tpl_vars['article']->value['image']) {?> <a href="../<?php echo $_smarty_tpl->tpl_vars['article']->value['image'];?>
" target="_blank"><img src="images/icon_picture.png" width="16" height="16" align="absMiddle"></a><?php }?></td>
      <td align="center"><?php if ($_smarty_tpl->tpl_vars['article']->value['cat_name']) {?><a href="article.php?cat_id=<?php echo $_smarty_tpl->tpl_vars['article']->value['cat_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['article']->value['cat_name'];?>
</a><?php } else {
echo $_smarty_tpl->tpl_vars['lang']->value['uncategorized'];
}?></td>
      <td align="center"><?php echo $_smarty_tpl->tpl_vars['article']->value['add_time'];?>
</td>
      <td align="center"><?php echo $_smarty_tpl->tpl_vars['article']->value['template'];?>
</td>
      <td align="center">
       <?php if ($_smarty_tpl->tpl_vars['if_sort']->value) {?>
       <a href="article.php?rec=set_sort&id=<?php echo $_smarty_tpl->tpl_vars['article']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['lang']->value['sort_btn'];?>
</a>
       <?php } else { ?>
       <a href="article.php?rec=edit&id=<?php echo $_smarty_tpl->tpl_vars['article']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['lang']->value['edit'];?>
</a> | <a href="article.php?rec=del&id=<?php echo $_smarty_tpl->tpl_vars['article']->value['id'];?>
...
" class="actionBtn"><?php echo $_smarty_tpl->tpl_vars['action_link']->value['text'];?>
    ...
    <form action="article.php?rec=<?php echo $_smarty_tpl->tpl_vars['form_action']->value;?>
" method="post" enctype="multipart/form-data">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="90" align="right"><?php echo $_smarty_tpl->tpl_vars['lang']->value['article_name'];?>
</td>
       <td>
...
" size="80" class="inpMain" />
      ...
      <tr>
       <td align="right"><?php echo $_smarty_tpl->tpl_vars['lang']->value['article_category'];?>
</td>
       <td>
        <select name="cat_id">
         <option value="0"><?php echo $_smarty_tpl->tpl_vars['lang']->value['uncategorized'];?>
...
foreach ($_from as $_smarty_tpl->tpl_vars['cate']->value) {
?>
         <?php if ($_smarty_tpl->tpl_vars['cate']->value['cat_id'] == $_smarty_tpl->tpl_vars['article']->value['cat_id']) {?>
         <option value="<?php echo $_smarty_tpl->tpl_vars['cate']->value['cat_id'];?>
" selected="selected"><?php echo $_smarty_tpl->tpl_vars['cate']->value['mark'];?>
 <?php echo $_smarty_tpl->tpl_vars['cate']->value['cat_name'];?>
</option>
...
?>
      ...
      <?php if ($_smarty_tpl->tpl_vars['article']->value['defined']) {?>
      <tr>
       <td align="right" valign="top"><?php echo $_smarty_tpl->tpl_vars['lang']->value['article_defined'];?>
</td>
       <td>
        <textarea name="defined" id="defined" cols="50" class="textAreaAuto" style="height:<?php echo $_smarty_tpl->tpl_vars['article']->value['defined_count'];?>
0px"><?php echo $_smarty_tpl->tpl_vars['article']->value['defined'];?>
</textarea>
        <?php echo '<script'; ?>
...
>
      ...
      <?php }?>
      <tr>
       <td align="right" valign="top"><?php echo $_smarty_tpl->tpl_vars['lang']->value['article_content'];?>
</td>
       <td>
        <!-- KindEditor -->
        <?php echo '<script'; ?>
...
>
        <!-- /KindEditor -->
        <textarea id="content" name="content" style="width:780px;height:400px;" class="textArea"><?php echo $_smarty_tpl->tpl_vars['article']->value['content'];?>
</textarea>
       </td>
      </tr>
      <tr>
       ...
       <td>
        ...
        <?php if ($_smarty_tpl->tpl_vars['article']->value['image']) {?><a href="../<?php echo $_smarty_tpl->tpl_vars['article']->value['image'];?>
" target="_blank"><img src="images/icon_yes.png"></a><?php } else { ?><img src="images/icon_no.png"><?php }?>
      ...
      <tr>
       ...
       <td>
        <input type="text" name="keywords" value="<?php echo $_smarty_tpl->tpl_vars['article']->value['keywords'];?>
" size="114" class="inpMain" />
      ...
      <tr>
       ...
       <td>
        <textarea name="description" cols="115" rows="3" class="textArea" /><?php echo $_smarty_tpl->tpl_vars['article']->value['description'];?>
</textarea>
       </td>
      </tr>
      <tr>
       ...
       <td>
        <input type="text" name="sort" value="<?php if ($_smarty_tpl->tpl_vars['article']->value['sort']) {
...
foreach ($_from as $_smarty_tpl->tpl_vars['tpl']->value) {
?>
                  <option value="<?php echo $_smarty_tpl->tpl_vars['tpl']->value['tpl'];?>
" <?php if ($_smarty_tpl->tpl_vars['article']->value['template'] == $_smarty_tpl->tpl_vars['tpl']->value['tpl']) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['tpl']->value['name'];?>
</option>
                  <?php
}
}
...
" />
        <input type="hidden" name="image_old" value="<?php echo $_smarty_tpl->tpl_vars['article']->value['image'];?>
">
